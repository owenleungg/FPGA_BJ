...
add wave -noupdate -label card_value -radix binary /testbench/n/fsm_inst/card_value
add wave -noupdate -label player_score -radix binary /testbench/n/fsm_inst/player_score
add wave -noupdate -label dealer_score -radix binary /testbench/n/fsm_inst/dealer_score
